 ...
 *       &lt;sequence>
 *         &lt;element name="Alternative" type="{http://www.legislation.gov.uk/namespaces/metadata}AlterType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Alternatives {
    ...
    protected List<AlterType> alternatives;
     ...
     * 
     */
    public List<AlterType> getAlternatives() {
        if (alternatives == null) {
            alternatives = new ArrayList<AlterType>();
        }
