...
@XmlType(name = "", propOrder = {
    "errorsAndWarningsAndTitles",
    "p1SAndPSAndIncludes"
})
@XmlRootElement(name = "P1group")
public class P1Group {

    @XmlElementRefs({
        @XmlElementRef(name = "Title", namespace = "http://www.legislation.gov.uk/namespaces/legislation", type = JAXBElement.class),
    ...
    protected List<JAXBElement<?>> errorsAndWarningsAndTitles;
    @XmlElements({
        @XmlElement(name = "P1", type = P1 .class),
        @XmlElement(name = "P", type = P.class),
        @XmlElement(name = "Include", type = Include.class)
    })
    protected List<Object> p1SAndPSAndIncludes;
    ...
    /**
     * Gets the value of the errorsAndWarningsAndTitles property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the errorsAndWarningsAndTitles property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getErrorsAndWarningsAndTitles().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    /**
     * Gets the value of the p1SAndPSAndIncludes property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the p1SAndPSAndIncludes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getP1SAndPSAndIncludes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
