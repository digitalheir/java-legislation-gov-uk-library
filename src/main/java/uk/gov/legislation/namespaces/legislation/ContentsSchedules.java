...
@XmlRootElement(name = "ContentsSchedules")
public class ContentsSchedules {

    @XmlElement(name = "ContentsTitle")
    protected ContentsTitle contentsTitle;
    @XmlElement(name = "ContentsSchedule", required = true)
    protected List<ContentsSchedule> contentsSchedules;
     ...
     * This is why there is not a <CODE>set</CODE> method for the contentsSchedules property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getContentsSchedules().add(newItem);
     * </pre>
     * 
     * 
     * <p>
