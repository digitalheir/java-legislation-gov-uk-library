 ...
 *         &lt;element ref="{http://www.legislation.gov.uk/namespaces/legislation}KeyListItem"/>
 *       &lt;/sequence>
...
public class KeyList {
    ...
    @XmlElement(name = "KeyListItem", required = true)
    protected List<KeyListItem> keyListItems;
    ...
    /**
     * Gets the value of the keyListItems property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the keyListItems property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getKeyListItems().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<KeyListItem> getKeyListItems() {
        if (keyListItems == null) {
            keyListItems = new ArrayList<KeyListItem>();
        }
        return this.keyListItems;
    }
