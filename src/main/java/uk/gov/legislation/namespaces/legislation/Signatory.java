 ...
 *         &lt;element ref="{http://www.legislation.gov.uk/namespaces/legislation}Signee" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
public class Signatory {
    ...
    @XmlElement(name = "Signee", required = true)
    protected List<Signee> signees;
    ...
    /**
     * Gets the value of the signees property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the signees property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSignees().add(newItem);
     * </pre>
     * 
     * 
     * <p>
