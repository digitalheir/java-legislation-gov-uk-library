 ...
 * 
 * <p>Java class for InlineStructure complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InlineStructure"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "InlineStructure", propOrder = {
    "content"
})
@XmlSeeAlso({
    InlineAmendment.class
})
public class InlineStructure {
    ...
    /**
     * A type that defines the complete content model for a standard paragraph level element, e.g. a para element, but without the formatting attributes Gets the value of the content property.
     * 
     * <p>
